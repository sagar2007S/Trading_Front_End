      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-gray-400">
        ...
        <div className="flex items-center gap-1">
          <Button 
            variant="ghost" 
            size="icon" 
            className="h-8 w-8 text-black bg-gray-400 dark:text-white hover:text-white hover:bg-blue-500"
          ...
          <Button 
            variant="ghost" 
            size="icon" 
            className="h-8 w-8 text-black bg-blue-400 hover:text-white hover:bg-blue-600"
